...
! - John Melkumov 2/21/2024
    ...
    ! Open output file
    open(unit=20, file='trimer.cnf', status='replace', action='write')
    ...
    do i = 1, 3
        ...
        do j = 1, num_atoms(i)
            ...
            write(20, '(3F12.6, 2F12.6, A2, A, A1, A)') x(i,j), y(i,j), z(i,j), nuc_charge(i,j), &
                                                  atm_mass(i,j), ' ', "'", atom_name(i,j), "'"
        end do
    end do
